<#
.SYNOPSIS
    Regenerate GOLDs for LARGE-tests/HUB75 using Windows PNut.

.DESCRIPTION
    Sourced from: src/tests/LARGE-tests/pnut-ts-large.test.ts (HUB75 subset)
      - Glob:    *.spin2 in this subdir
      - Default: -c (matches legacy LARGE-HUB75-rebuild-v52)
#>
param(
    [int]$PNutVersion = 55,
