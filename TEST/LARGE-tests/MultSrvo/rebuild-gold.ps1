<#
.SYNOPSIS
    Regenerate GOLDs for LARGE-tests/MultSrvo using Windows PNut.

.DESCRIPTION
    Sourced from: src/tests/LARGE-tests/pnut-ts-large.test.ts (MultSrvo subset)
      - Glob:    *.spin2 in this subdir
      - Default: -c
      - Pattern: demo_quad* -> -cd (matches legacy LARGE-MultSrvo-rebuild-v52)
#>
param(
    [int]$PNutVersion = 55,
