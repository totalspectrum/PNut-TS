<#
.SYNOPSIS
    Regenerate GOLDs for LARGE-tests/eInk using Windows PNut.

.DESCRIPTION
    Sourced from: src/tests/LARGE-tests/pnut-ts-large.test.ts (eInk subset)
      - Glob:    *.spin2 in this subdir
      - Default: -c (matches legacy LARGE-eInk-rebuild-v52)
#>
param(
    [int]$PNutVersion = 55,
