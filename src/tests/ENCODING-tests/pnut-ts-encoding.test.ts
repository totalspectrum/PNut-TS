...
// test lives in <rootDir>/src/tests/ENCODING-tests
const testDirPath = path.resolve(__dirname, '../../../TEST/ENCODING-tests');
...
describe('PNut_ts compiles .spin2 PASM2 encoding tests correctly', () => {
  let files: string[] = [];
