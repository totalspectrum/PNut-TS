...
export enum eElementType {
  ...
  type_offsetof = 39, // 0x27 OFFSETOF
  type_size = 40, // 0x28 BYTE, WORD, LONG
  type_size_fit = 41, // 0x29 BYTEFIT, WORDFIT
  type_fvar = 42, // 0x2A FVAR, FVARS
  type_file = 43, // 0x2B FILE
  type_if = 44, // 0x2C IF
  type_ifnot = 45, // 0x2D IFNOT
  type_elseif = 46, // 0x2E ELSEIF
  type_elseifnot = 47, // 0x2F ELSEIFNOT
  type_else = 48, // 0x30 ELSE
  type_case = 49, // 0x31 CASE
  type_case_fast = 50, // 0x32 CASE_FAST
  type_other = 51, // 0x33 OTHER
  type_repeat = 52, // 0x34 REPEAT
  type_repeat_var = 53, // 0x35 REPEAT var - different QUIT method
  type_repeat_count = 54, // 0x36 REPEAT count - different QUIT method
  type_repeat_count_var = 55, // 0x37 REPEAT count WITH var - different QUIT method
  type_while = 56, // 0x38 WHILE
  type_until = 57, // 0x39 UNTIL
  type_from = 58, // 0x3A FROM
  type_to = 59, // 0x3B TO
  type_step = 60, // 0x3C STEP
  type_with = 61, // 0x3D WITH
  type_i_next_quit = 62, // 0x3E NEXT/QUIT
  type_i_return = 63, // 0x3F RETURN
  type_i_abort = 64, // 0x40 ABORT
  type_i_look = 65, // 0x41 LOOKUPZ, LOOKUP, LOOKDOWNZ, LOOKDOWN
  type_i_cogspin = 66, // 0x42 COGSPIN
  type_i_taskspin = 67, // 0x43 TASKSPIN
  type_i_flex = 68, // 0x44 HUBSET, COGINIT, COGSTOP...
  type_recv = 69, // 0x45 RECV
  type_send = 70, // 0x46 SEND
  type_debug = 71, // 0x47 DEBUG
  type_debug_cmd = 72, // 0x48 DEBUG commands
  type_asm_end = 73, // 0x49 END
  type_asm_dir = 74, // 0x4A ORGH, ORG, ORGF, RES, FIT
  type_asm_cond = 75, // 0x4B IF_C, IF_Z, IF_NC, etc
  type_asm_inst = 76, // 0x4C RDBYTE, RDWORD, RDLONG, etc.
  type_asm_effect = 77, // 0x4D WC, WZ, WCZ
  type_asm_effect2 = 78, // 0x4E ANDC, ANDZ, ORC, ORZ, XORC, XORZ
  type_reg = 79, // 0x4F REG
  type_con_int = 80, // 0x50 C0 user constant integer (C0..C2 must be contiguous)
  type_con_float = 81, // 0x51 C1 user constant float
  type_con_struct = 82, // 0x52 C2 user data structure
  type_register = 83, // 0x53 user register long
  type_loc_byte = 84, // 0x54 L0 user loc byte (L0..L11 must be contiguous)
  type_loc_word = 85, // 0x55 L1 user loc word
  type_loc_long = 86, // 0x56 L2 user loc long
  type_loc_struct = 87, // 0x57 L3 user loc struct
  type_loc_byte_ptr = 88, // 0x58 L4 user loc byte ptr
  type_loc_word_ptr = 89, // 0x59 L5 user loc word ptr
  type_loc_long_ptr = 90, // 0x5A L6 user loc long ptr
  type_loc_struct_ptr = 91, // 0x5B L7 user loc struct ptr
  type_loc_byte_ptr_val = 92, // 0x5C L8 internal loc byte ptr val
  type_loc_word_ptr_val = 93, // 0x5D L9 internal loc word ptr val
  type_loc_long_ptr_val = 94, // 0x5E L10 internal loc long ptr val
  type_loc_struct_ptr_val = 95, // 0x5F L11 internal loc struct ptr val
  type_var_byte = 96, // 0x60 V0 user var byte (V0..V11 must be contiguous)
  type_var_word = 97, // 0x61 V1 user var word
  type_var_long = 98, // 0x62 V2 user var long
  type_var_struct = 99, // 0x63 V3 user var struct
  type_var_byte_ptr = 100, // 0x64 V4 user var byte ptr
  type_var_word_ptr = 101, // 0x65 V5 user var word ptr
  type_var_long_ptr = 102, // 0x66 V6 user var long ptr
  type_var_struct_ptr = 103, // 0x67 V7 user var struct ptr
  type_var_byte_ptr_val = 104, // 0x68 V8 internal var byte ptr val
  type_var_word_ptr_val = 105, // 0x69 V9 internal var word ptr val
  type_var_long_ptr_val = 106, // 0x6A V10 internal var long ptr val
  type_var_struct_ptr_val = 107, // 0x6B V11 internal var struct ptr val
  type_dat_byte = 108, // 0x6C D0 user dat byte (D0..D3 must be contiguous)
  type_dat_word = 109, // 0x6D D1 user dat word
  type_dat_long = 110, // 0x6E D2 user dat long
  type_dat_struct = 111, // 0x6F D3 user dat struct
  type_dat_long_res = 112, // 0x70 (D2) user dat long reserve
  type_hub_byte = 113, // 0x71 H0 user hub byte (unused) (H0..H2 must be contiguous)
  type_hub_word = 114, // 0x72 H1 user hub word (unused)
  type_hub_long = 115, // 0x73 H2 user hub long (CLKMODE, CLKFREQ)
  type_obj = 116, // 0x74 user object
  type_obj_con_int = 117, // 0x75 O1 user object.constant integer (O0..O2 must be contiguous)
  type_obj_con_float = 118, // 0x76 O2 user object.constant float
  type_obj_con_struct = 119, // 0x77 O3 user object.constant structure
  type_obj_pub = 120, // 0x78 user object.method()
  type_method = 121, // 0x79 user method
  type_end = 122, // 0x7A end of line
  type_end_file = 123 // 0x7B end-of-file
}
...
export enum eByteCode {
  ...
  // Variable-operator LUT — v55 packed downward from $79..$DF to $15..$7F.
  // Dispatched via LUT base $215 (compiler arms with `setq2 #$081`).
  bc_set_incdec_rfvar = 21, // 0x15 (renamed from bc_set_incdec; moved from 0x79)
  bc_repeat_var_init_n = 22, // 0x16
  bc_repeat_var_init_1 = 23, // 0x17
  bc_repeat_var_init = 24, // 0x18
  bc_repeat_var_loop = 25, // 0x19
  bc_get_field = 26, // 0x1a
  bc_get_addr = 27, // 0x1b
  bc_read = 28, // 0x1c
  bc_write = 29, // 0x1d
  bc_write_push = 30, // 0x1e
  bc_var_inc = 31, // 0x1f
  bc_var_dec = 32, // 0x20
  bc_var_preinc_push = 33, // 0x21
  bc_var_predec_push = 34, // 0x22
  bc_var_postinc_push = 35, // 0x23
  bc_var_postdec_push = 36, // 0x24
  bc_var_lognot = 37, // 0x25
  bc_var_lognot_push = 38, // 0x26
  bc_var_bitnot = 39, // 0x27
  bc_var_bitnot_push = 40, // 0x28
  bc_var_swap = 41, // 0x29
  bc_var_rnd = 42, // 0x2a
  bc_var_rnd_push = 43, // 0x2b
  bc_lognot_write = 44, // 0x2c
  bc_bitnot_write = 45, // 0x2d
  bc_neg_write = 46, // 0x2e
  bc_abs_write = 47, // 0x2f
  bc_encod_write = 48, // 0x30
  bc_decod_write = 49, // 0x31
  bc_bmask_write = 50, // 0x32
  bc_ones_write = 51, // 0x33
  bc_sqrt_write = 52, // 0x34
  bc_qlog_write = 53, // 0x35
  bc_qexp_write = 54, // 0x36
  bc_shr_write = 55, // 0x37
  bc_shl_write = 56, // 0x38
  bc_sar_write = 57, // 0x39
  bc_ror_write = 58, // 0x3a
  bc_rol_write = 59, // 0x3b
  bc_rev_write = 60, // 0x3c
  bc_zerox_write = 61, // 0x3d
  bc_signx_write = 62, // 0x3e
  bc_add_write = 63, // 0x3f
  bc_sub_write = 64, // 0x40
  bc_logand_write = 65, // 0x41
  bc_logxor_write = 66, // 0x42
  bc_logor_write = 67, // 0x43
  bc_bitand_write = 68, // 0x44
  bc_bitxor_write = 69, // 0x45
  bc_bitor_write = 70, // 0x46
  bc_fge_write = 71, // 0x47
  bc_fle_write = 72, // 0x48
  bc_addbits_write = 73, // 0x49
  bc_addpins_write = 74, // 0x4a
  bc_mul_write = 75, // 0x4b
  bc_div_write = 76, // 0x4c
  bc_divu_write = 77, // 0x4d
  bc_rem_write = 78, // 0x4e
  bc_remu_write = 79, // 0x4f
  bc_sca_write = 80, // 0x50
  bc_scas_write = 81, // 0x51
  bc_frac_write = 82, // 0x52
  bc_lognot_write_push = 83, // 0x53
  bc_bitnot_write_push = 84, // 0x54
  bc_neg_write_push = 85, // 0x55
  bc_abs_write_push = 86, // 0x56
  bc_encod_write_push = 87, // 0x57
  bc_decod_write_push = 88, // 0x58
  bc_bmask_write_push = 89, // 0x59
  bc_ones_write_push = 90, // 0x5a
  bc_sqrt_write_push = 91, // 0x5b
  bc_qlog_write_push = 92, // 0x5c
  bc_qexp_write_push = 93, // 0x5d
  bc_shr_write_push = 94, // 0x5e
  bc_shl_write_push = 95, // 0x5f
  bc_sar_write_push = 96, // 0x60
  bc_ror_write_push = 97, // 0x61
  bc_rol_write_push = 98, // 0x62
  bc_rev_write_push = 99, // 0x63
  bc_zerox_write_push = 100, // 0x64
  bc_signx_write_push = 101, // 0x65
  bc_add_write_push = 102, // 0x66
  bc_sub_write_push = 103, // 0x67
  bc_logand_write_push = 104, // 0x68
  bc_logxor_write_push = 105, // 0x69
  bc_logor_write_push = 106, // 0x6a
  bc_bitand_write_push = 107, // 0x6b
  bc_bitxor_write_push = 108, // 0x6c
  bc_bitor_write_push = 109, // 0x6d
  bc_fge_write_push = 110, // 0x6e
  bc_fle_write_push = 111, // 0x6f
  bc_addbits_write_push = 112, // 0x70
  bc_addpins_write_push = 113, // 0x71
  bc_mul_write_push = 114, // 0x72
  bc_div_write_push = 115, // 0x73
  bc_divu_write_push = 116, // 0x74
  bc_rem_write_push = 117, // 0x75
  bc_remu_write_push = 118, // 0x76
  bc_sca_write_push = 119, // 0x77
  bc_scas_write_push = 120, // 0x78
  bc_frac_write_push = 121, // 0x79
  bc_setup_bfield_pop = 122, // 0x7a
  bc_read_bfield_pop = 123, // 0x7b  v55 NEW
  bc_write_bfield_pop = 124, // 0x7c  v55 NEW
  bc_setup_bfield_rfvar = 125, // 0x7d
  bc_read_bfield_rfvar = 126, // 0x7e  v55 NEW
  bc_write_bfield_rfvar = 127, // 0x7f  v55 NEW
  // 32-entry compressed blocks at $80..$FF of the variable-op LUT.
  // Values collide numerically with main-LUT entries ($A0..$F0) — this is
  // intentional dual-LUT design; runtime dispatch picks the correct LUT
  // based on whether the previous bytecode armed `setq2 #$081`.
  bc_set_incdec_2_33 = 128, // 0x80 ($80..$9F, 32 entries) v55 NEW — inline ++/-- step 2..33
  bc_setup_bfield_0_31 = 160, // 0xa0 ($A0..$BF, 32 entries) v55 RELOCATED from 0xE0
  bc_read_bfield_0_31 = 192, // 0xc0 ($C0..$DF, 32 entries) v55 NEW
  bc_write_bfield_0_31 = 224, // 0xe0 ($E0..$FF, 32 entries) v55 NEW
